...
public class VALIDATE_FAIL extends RulesTemplate
{

    public VALIDATE_FAIL()
    {
    }
    ...
    public void validation(SubscriberInfo subscriberinfo) throws Exception
    {
        ...
        subscriberinfo.setStatus(SubscriberStatus.K_DENIED);
        subscriberinfo.setReason(SubscriberStatusReason.BLOCKED_MSISDN);
    }
